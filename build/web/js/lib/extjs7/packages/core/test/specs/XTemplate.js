topSuite("Ext.XTemplate", ['Ext.dom.Element'], function() {
    var tpl, data, arrayData, objectData;
                            ...
                            '<tpl for="menus">',
                                '<div class="dv-element small" id="{id}" test="{test}" sample="{sample}" cmpName="{cmpName}">',
                                    '<span>',
                                        '<img src="img/icons/{icon}.png" title="{name}" align="left">',
                                        '<tpl if="values.test * values.sample == 0">',
                                            '<i class="button-icon-padding fa fa-exclamation-circle fa-lg" aria-hidden="true" align="right" title="{[ values.sample == 0 ? \'Sample Text 1\' : \'Sample Text 2\' ]}">',
                                        '</tpl>',
                                        '<span class="boldText" style="float:left;">',
                                            '{name}',
                                        '</span>',
