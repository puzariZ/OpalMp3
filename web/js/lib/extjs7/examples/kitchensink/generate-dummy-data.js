...
function formatDate(d) {
    return leftPad(d.getFullYear(), 4, '0') +
...
function createFakeData(count) {
    var firstNames = ['Kane', 'Kynan', 'Bobbie', 'Maddox', 'Katerina',
        ...
        data = [],
        firstName, lastName, name, email, rating, salary, department, ageInYears,
        dob, i, joinDate, sickDays, holidayDays, holidayAllowance;
